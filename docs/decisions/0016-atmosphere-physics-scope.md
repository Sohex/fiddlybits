...
- 2026-09-14: the water continuum with CO2 as perturber is `Bracketed`, since no measurement of it is read; Tran et al. (2018) measure CO2 absorbing with water as perturber and stay cited for that pair. The low end is the MT_CKD water-air foreign continuum (Mlawer et al. 2012), pushed down by a perturber no more effective than nitrogen and oxygen. The high end is twenty times the water-nitrogen foreign continuum, the ratio near 1100 cm-1 at room temperature that Tran et al. (2018, p. 2) report from the measurement of Baranov (2016), pushed up by the stronger far-wing interaction of water lines with CO2; away from that wavenumber and temperature the high end is a declared extrapolation recorded with the table's provenance. The high end is quoted through Tran et al. (2018) until Baranov (2016), "On the significant enhancement of the continuum-collision induced absorption in H2O+CO2 mixtures", 10.1016/j.jqsrt.2016.02.017, is read. User decision of 2026-09-14, raised by notes/findings/2026-09-14-an-audit-of-source-fitness.md; the index rows are carried by fiddlybits-wvu and the fetch of Baranov (2016) by fiddlybits-tr8.
