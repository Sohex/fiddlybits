...
| DrWatson.jl, ScienceProjectTemplate, GoodScientificCodeWorkshop, doctheme, DynamicalSystemsDocs.jl, ExercisesRepo, NonlinearDynamicsComplexSystemsCourse, NonlinearDynamicsTextbook, JuliaDynamics, JuliaDynamics-NGRIP, example-python | reproducibility tooling, documentation theming and ecosystem-wide docbuild, course and textbook material, org website | - | not pertinent -- process and pedagogy, not domain content |
...
| PredefinedDynamicalSystems.jl | a library of textbook example systems (Lorenz, Rssler, etc.) for the ecosystem | - | not pertinent -- example fixtures |
